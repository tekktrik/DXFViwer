# DXF Viewer- Frontend Code

This directory contains the frontend code for the DXF Viewer plugin.
...
This will compile the frontend into the `../dxf_viewer/static` directory (ready for distribution).
